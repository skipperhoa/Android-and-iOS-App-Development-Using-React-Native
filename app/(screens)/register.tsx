    ...
    <View className='flex-1 items-center justify-center'>
      ...
      <View className='w-full px-10'>
          <View className='w-full py-1'>
              <Text className='w-full text-sm text-gray-500'>Name</Text>
              <TextInput className='w-full block p-2 border-1 border-gray-200 bg-gray-200'/>
          </View>
          <View className='w-full py-1'>
          ...
          <View className='w-full py-1'>
              <Text className='w-full text-sm text-gray-500'>Phone</Text>
              <TextInput className='w-full block p-2 border-1 border-gray-200 bg-gray-200' keyboardType="phone-pad"/>
          </View>
          <View className='w-full py-1'>
