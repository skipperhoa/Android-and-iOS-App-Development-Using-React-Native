import { View, Text, SafeAreaView, TouchableOpacity, TextInput,Platform, Image } from 'react-native'
...
const LocationScreen = () => {
  ...
  return (
    <>
      ...
      {checkPlatform() === "android" && <View style={{ height: Constants.statusBarHeight }} />}
