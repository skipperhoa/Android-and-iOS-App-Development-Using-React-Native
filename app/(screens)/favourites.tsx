  ...
  return (
    <LinearGradient colors={["#E27E07", "#FB8A04","#FDD29F"]}>
     ...
     <View className='w-full h-full'>
        ...
        <View className='w-full px-4 flex-1 h-full pt-4'>
            <View className='w-full h-full flex flex-col'>
                    <View className='w-full  flex-1 rounded-xl bg-white'>
                        <ScrollView className='w-full pt-2  p-4'>
                                <View className='w-full'>
                   ...
                   <View className='w-full'>
                        <View className='w-full flex flex-col items-center justify-between py-2'>
